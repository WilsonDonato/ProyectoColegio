<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIRECTOR.aspx.cs" Inherits="ProyectoColegio.DIRECTOR" %>
                    ...
                    <nav class="navbar navbar-expand-lg bg-warning navbar-warning">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto">
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 DIRECTOR: <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>, <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
