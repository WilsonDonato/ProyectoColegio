<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ESTUDIANTE.aspx.cs" Inherits="ProyectoColegio.ESTUDIANTE" %>
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto">
                                ...
                                <a class="btn" href="VERMATERIAL.aspx">VER MATERIALES SUBIDOS DEL COLEGIO</a>
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 ESTUDIANTE: <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>,</asp:Label> <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Black"></asp:Label>
