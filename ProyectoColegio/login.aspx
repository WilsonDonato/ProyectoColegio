<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ProyectoColegio.frmLogin" %>
                    ...
                    <nav class="navbar navbar-expand-lg bg-warning navbar-warning">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto">
                                 <a class="btn" href="frmMision.aspx">MISION - VISIÓN</a>
    ...
    <form id="form1" runat="server">
        <div class="background-wrap">
                ...
                <form id="accesspanel" action="login" method="post">
                  <h1 id="litheader">INSTITUCIÓN EDUCATIVA MARISCAL GAMARRA</h1>
                    <img src="img/lgos.png" width="130" alt="Carousel Image"/>
                  <div class="inset">
                    <p>
     
                        <asp:TextBox type="text" ID="txtUsuario" class="text-center" placeholder="Usuario" name="Usuario" runat="server"></asp:TextBox>
                    </p>
                    <p>
     
                         <asp:TextBox type="password" ID="txtClave" class="text-center" placeholder="Contraseña" name="Contraseña" runat="server"></asp:TextBox>
                    </p>
                  ...
                  <p class="p-container">
                      <asp:Button ID="btnIngresar" runat="server" value="INGRESAR" Text="INGRESAR" OnClick="btnIngresar_Click" />
    ...
    <div class="nav-bar">
                <div class="fixed-bottom">
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                       <a href="#" class="navbar-brand"> LAS LOBAS:</a>
                        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                            <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto">
                                <a href="#" class="navbar-brand">WILSON HOLGUIN</a>
                                <a href="#" class="navbar-brand">ROMULO VALDIVIA</a>
                                <a href="#" class="navbar-brand">FRABRICIO FARFAN</a>
                                <a href="#" class="navbar-brand">DIEGO PEREIRA</a>
